...
- **10%** daily prize pot
- **10%** buyback and burn
- **80%** buy top Robinhood tokens (e.g. `$PONS`) and airdrop to holders with at least **1,500,000** `$PONSCADE`
...
Not shipped yet: fee-claim bot, real payouts to typed addresses, holder snapshot for the 1,500,000 airdrop floor.
